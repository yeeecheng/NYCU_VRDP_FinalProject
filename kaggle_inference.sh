...
CUDA_VISIBLE_DEVICES="0" python inference_with_DACLIP.py --input ./dataset/test/lr \
    --output ./kaggle_test_HR_result/pre-trained_with_kaggle_dataset_with_DACLIP_TTA_v3_95000\
    --model_path /swim-pool/yicheng/NYCU_VRDP_FinalProject/experiments/train_DRCT_SRx4_finetune_from_DRCT_pre-train_with_DACLIP/models/net_g_95000.pth \
    --start_idx 0 --end_idx 3600
